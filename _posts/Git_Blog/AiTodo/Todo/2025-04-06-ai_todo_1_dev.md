...
1. [_[ AI_Todo 프로젝트 개발기 - DevOps #1 ] JavaScript로 세 마리 토끼 잡는 방법_](https://ramyo564.github.io/git_blog/project_ai_todo/ai_todo_1_d_pnpm_turbo/)
2. [_[ AI_Todo 프로젝트 개발기 - DevOps #2] ESLint와 Husky로 나만의 품질 파이프라인 구축하기_](https://ramyo564.github.io/git_blog/project_ai_todo/ai_todo_2_d_husky_eslint/)
3. [_[ AI_Todo 프로젝트 개발기 - DevOps #3] 환경설정 통일 Docker가 아닌 MIse를 선탁한 이유_](https://ramyo564.github.io/git_blog/project_ai_todo/ai_todo_3_d_mise/)

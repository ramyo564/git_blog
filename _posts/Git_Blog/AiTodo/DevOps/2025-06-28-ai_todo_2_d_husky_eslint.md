...
**CPU** 를 **Intel** 에서 **Ryzen** 으로 바꾸면서 **Windows** 를 포맷해야 했는데 어찌 된 일인지, 전보다 개발 환경이 더 느려진 기분이 들었습니다.  "차라리 **Linux** 로 갈까?" 고민도 했지만, 예를 들어 카카오톡 같은 프로그램을 `wine`으로 설치하며 시간을 쓰고 싶진 않았습니다.    
